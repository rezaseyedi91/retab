...
CREATE TABLE `DocSettings` (
    ...
    `fixedMeasures` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `EncoderHeader` (
    ...
    UNIQUE INDEX `EncoderHeader_headerTagId_userId_key`(`headerTagId`, `userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `EncoderHeader` ADD CONSTRAINT `EncoderHeader_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
